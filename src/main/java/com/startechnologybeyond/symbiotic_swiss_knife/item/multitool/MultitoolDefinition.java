...
public class MultitoolDefinition implements IGTToolDefinition {
    public static final MultitoolDefinition INSTANCE = new MultitoolDefinition();

    private MultitoolDefinition() {
    }
