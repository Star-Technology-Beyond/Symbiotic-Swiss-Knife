...
public class MultitoolItem extends GTToolItem {
    ...
    private static final String DISPLAY_KEY = "item.symbiotic_swiss_knife.gregtech_multitool";
    ...
    public MultitoolItem(GTToolType toolType, MaterialToolTier tier, Material material, Properties properties,
            int electricTier) {
        super(toolType, tier, material, MultitoolDefinition.INSTANCE, properties);
    ...
    public Component getName(ItemStack stack) {
        ...
        if (active == null) {
            return base.copy()
                    ...
                    .append(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.empty")
    ...
    public InteractionResult onItemUseFirst(ItemStack stack, UseOnContext context) {
        for (IToolBehavior behavior : MultitoolDefinition.INSTANCE.getBehaviors(stack)) {
    ...
    public boolean onBlockStartBreak(ItemStack stack, BlockPos pos, Player player) {
        ...
        MultitoolDefinition.INSTANCE.getBehaviors(stack)
    ...
    public boolean canDisableShield(ItemStack stack, ItemStack shield, LivingEntity entity, LivingEntity attacker) {
        return MultitoolDefinition.INSTANCE.getBehaviors(stack).stream()
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        return MultitoolDefinition.INSTANCE.canApplyEnchantment(stack, enchantment);
    }
    ...
    public boolean isCorrectToolForDrops(ItemStack stack, BlockState state) {
        if (isOutOfEnergy(stack))
            return false;
        if (MultitoolMode.getActive(stack) == null)
            return false;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents,
        ...
        MultitoolMode active = MultitoolMode.getActive(stack);
        if (active != null) {
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.hint")
                    .withStyle(ChatFormatting.GRAY));
        } else {
            // show fancy description for empty tool
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.line"));
            tooltipComponents.add(Component.translatable("block.symbiotic_swiss_knife.breaker_line"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l1"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l2"));
            tooltipComponents.add(Component.empty());
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l3"));
            tooltipComponents.add(Component.translatable("block.symbiotic_swiss_knife.breaker_line"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l5"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l6"));
            tooltipComponents.add(Component.translatable("block.symbiotic_swiss_knife.breaker_line"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l7"));
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.l8"));
            tooltipComponents.add(Component.empty());
        ...
        if (!installed.isEmpty()) {
            tooltipComponents.add(Component.empty());
            tooltipComponents.add(Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.installed")
        ...
        IGTToolDefinition proxyStats = MultitoolDefinition.INSTANCE;
