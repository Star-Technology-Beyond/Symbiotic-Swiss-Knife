...
import com.startechnologybeyond.symbiotic_swiss_knife.item.multitool.MultitoolAutoSelectRules.Rule;
...
public class MultitoolAutoSelectScreen extends Screen {
    ...
    public MultitoolAutoSelectScreen(ItemStack stack, InteractionHand hand) {
        super(Component.translatable("screen.symbiotic_swiss_knife.auto_select_rules"));
        this.stack = stack;
        this.hand = hand;
    ...
    protected void init() {
        ...
        regexField.setHint(
                Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.regex_pattern_placeholder")
    ...
    private void renderHeaders(GuiGraphics g) {
        ...
        g.drawString(font,
                Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.auto_select_rules_header")
    ...
    private void renderAddRow(GuiGraphics g, int mouseX, int mouseY, float partialTicks) {
        ...
        g.drawCenteredString(font, Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.add_btn"),
                px + ADD_BTN_X + ADD_BTN_W / 2, ary + ADD_ICON_Y,
    ...
    private void renderSave(GuiGraphics g, int mouseX, int mouseY) {
        ...
        g.drawCenteredString(font, Component.translatable("item.symbiotic_swiss_knife.gregtech_multitool.save_btn"),
                px + PANEL_W / 2, by + SAVE_MARGIN_Y + SAVE_BTN_H / 2 - SAVE_BTN_TEXT_ADJUST,
    ...
    private void saveAndClose() {
        ...
        // for faster feedback
        MultitoolAutoSelectRules.setRules(stack, rules);
        SymbioticNetwork.NETWORK.sendToServer(new CPacketSaveAutoSelectRules(hand, rules));
        onClose();
    }
